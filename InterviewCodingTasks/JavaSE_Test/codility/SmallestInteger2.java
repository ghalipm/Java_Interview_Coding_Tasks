...
// must find an efficient alternative
class SmallestInteger2 {
    ...
    public static int solutionD(int[] arr) {
        ...
        for (int i = 0; i < arr.length; i++) {
            if(arr[i]==smallestInt){smallestInt++;}
        }
        return smallestInt;
    }

    public static void main(String[] args) {
        int[] A={0, 1, 2, 3, 5};//A={0, 1, 2, 3, 5}; // A={1, 3, 6, 4, 1, 2};
        System.out.println("solutionB(A) = " + solutionB(A));
        System.out.println("solutionC(A) = " + solutionC(A));
        System.out.println("solutionD(A) = " + solutionD(A));
