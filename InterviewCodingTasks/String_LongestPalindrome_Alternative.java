...
public class String_LongestPalindrome_Alternative {

    // find the longest palindrome in a string:
    // str="  abba racecar     babayega        qamaq " --> "racecar"
    ...
    public static String[] arrayMakerOutOfString(String str){
        ...
        System.out.println("str.length() = " + str.length());
        // remove white space inside the string except is it just one white space
        while(str.contains("  ")){
